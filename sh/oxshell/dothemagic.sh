...
then
	...
	P2P=`ls -lt *loud* | head -n 7 | tail -n 6 | awk '{ print $8 ; }' | head -n 1`
	...
	P2P=`ls -lt *loud* | head -n 7 | tail -n 6 | awk '{ print $9 ; }' | head -n 1`
	...
	p2=`ls -lt | head -n 2 | tail -n 1 | awk '{ print $9 ; }' | xargs cat | grep "loud" | head -n 1 | awk '{ print $8; }'`
